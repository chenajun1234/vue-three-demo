...
export default {
  ...
  methods: {
    ...
    initLight() {
      ...
      //创建一个平行光光源照射到物体上     
      this.pointLight  = new THREE.PointLight(0xffffff); //聚光灯
    ...
    initGui() {      
        ...
        datGui.addColor(this.gui,"pointLight").onChange(function (e) {
            window.vue.pointLight.color = new THREE.Color(e);
        });
