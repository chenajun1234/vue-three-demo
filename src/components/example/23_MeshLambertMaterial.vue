    ...
    initGui() {      
      this.gui = {
        ...
        datGui.add(this.gui,"visible").onChange(function (e) {
            window.vue.directionalLight.visible = e;
        });
        datGui.add(this.gui,"castShadow").onChange(function (e) {
            window.vue.directionalLight.castShadow = e;
        });
        datGui.add(this.gui,"debug").onChange(function (e) {
            if(e){
                var debug = new THREE.CameraHelper(window.vue.directionalLight.shadow.camera);
                debug.name = "debug";
